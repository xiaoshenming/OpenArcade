...
它依次执行 50 个单元/集成测试、零警告 Lint、TypeScript 生产构建、300 行与资产哈希/许可证/包体门禁，以及桌面和移动 Chromium 的 14 个浏览器测试。
...
当前构建主包约 88 KB gzip；花笺成双约 3.0 KB gzip，包含 60 关数据的琉璃分色约 4.9 KB gzip。
